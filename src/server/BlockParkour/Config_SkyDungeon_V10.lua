...
local Config = {
	...
	-- Publica cedo o mesmo alvo de intencao usado pela geracao. Sistemas
	-- pessoais, como o Mercador do Ceu local, podem se preparar na proxima
	-- ilha sem esperar o jogador pisa-la.
	FRONTIER_INTENT_PUBLISH_SUSTAIN_SECONDS = 0.2,
	FRONTIER_INTENT_PUBLISH_MIN_PROGRESS_STUDS = 1.25,
	FRONTIER_INTENT_PUBLISH_STALE_SECONDS = 1.25,
